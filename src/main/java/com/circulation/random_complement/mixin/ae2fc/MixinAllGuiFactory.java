...
@Mixin(value = GuiType.AllGuiFactory.class, remap = false)
public abstract class MixinAllGuiFactory<T> extends GuiType.PartOrTileGuiFactory<T> {

    public MixinAllGuiFactory(Class<T> invClass) {
        super(invClass);
    }
